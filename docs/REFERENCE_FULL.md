# Full Technical Reference (Legacy README)

This document preserves the complete technical deep-dive that previously lived in `README.md`.

For a concise overview focused on what issueclaw does, installation, and AI-developer workflow, start at:
